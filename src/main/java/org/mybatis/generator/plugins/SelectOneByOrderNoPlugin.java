...
import org.mybatis.generator.plugins.utils.XmlElementGeneratorTools;
 ...
 * ---------------------------------------------------------------------------
 */
public class SelectOneByOrderNoPlugin extends BasePlugin {
    public static final String METHOD_SELECT_ONE_BY_ORDERNO = "selectOneByOrderNo";  // 方法名
    ...
    public boolean clientGenerated(Interface interfaze, TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        Method method = JavaElementGeneratorTools.generateMethod(
                METHOD_SELECT_ONE_BY_ORDERNO,
                JavaVisibility.DEFAULT,
                JavaElementGeneratorTools.getModelTypeWithoutBLOBs(introspectedTable),
                new Parameter(new FullyQualifiedJavaType("String"), "orderNo")
        );
        commentGenerator.addGeneralMethodComment(method, introspectedTable);
    ...
    public boolean sqlMapDocumentGenerated(Document document, IntrospectedTable introspectedTable) {
        ...
        // 添加ID
        selectOneElement.addAttribute(new Attribute("id", METHOD_SELECT_ONE_BY_ORDERNO));
        // 添加返回类型
        selectOneElement.addAttribute(new Attribute("resultMap", introspectedTable.getBaseResultMapId()));
        // 添加参数类型
        selectOneElement.addAttribute(new Attribute("parameterType", "java.lang.String"));
        ...
        sb.append("where");
        sb.append(" ");
        sb.append(" order_no = #{orderNo,jdbcType=VARCHAR}");
...
//        ifElement.addElement(new TextElement("order by ${orderByClause}"));
        selectOneElement.addElement(new TextElement("order by create_date desc"));
